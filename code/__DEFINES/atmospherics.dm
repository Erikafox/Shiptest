...
//PLANETARY
/// what pressure you have to be under to increase the effect of equipment meant for low pressure
#define LOW_PRESSURE_EQUIPMENT_PRESSURE 90

///detects unset planetary atmos
