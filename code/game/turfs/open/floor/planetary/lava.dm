...
/turf/open/floor/planetary/lava/MakeSlippery(wet_setting, min_wet_time, wet_time_to_add, max_wet_time, permanent)
	return
...
/turf/open/floor/planetary/lava/MakeDry(wet_setting = TURF_WET_WATER)
	return

/turf/open/floor/planetary/lava/airless
...
/turf/open/floor/planetary/lava/rcd_act(mob/user, obj/item/construction/rcd/the_rcd, passed_mode)
	switch(passed_mode)
		if(RCD_FLOORWALL)
			...
			PlaceOnTop(/turf/open/floor/planetary/floor/plating, flags = CHANGETURF_INHERIT_AIR)
			return TRUE
	return FALSE
...
/turf/open/floor/planetary/lava/TakeTemperature(temp)

/turf/open/floor/planetary/lava/attackby(obj/item/attacking_item, mob/user, params)
	..()
